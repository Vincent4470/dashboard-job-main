    ...
    <div>
      <div className="grid grid-cols-3 w-full gap-5">
        <div className="col-span-2 space-y-10">
          ...
          <div className="text-gray-500 mt-3">
            <p>
              ...
              vel ipsum dolorum, nam aliquid, totam qui hic molestias provident
              repellat laborum. Facere iure incidunt facilis? Veniam ipsum
              dolores esse corporis.
            </p>
          </div>
        ...
        <div>
          ...
          <div className="shadow p-3 text-center mt-6 my-6">
          ...
          <div className="mb-10 space-y-5">
            <div className="flex justify-between">
              ...
              <div className="font-semibold">12 Agu 2023</div>
            </div>
            <div className="flex justify-between">
      ...
      <div>
        ...
        <div className="text-gray-500">
          This job comes with several perks and benfits
        </div>
      </div>
